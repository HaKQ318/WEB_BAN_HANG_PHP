            ...
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td style="text-align:center;width:150px;" >
                        <a href="index.php?controller=products&action=update&id=<?php echo $rows->id; ?>"><button>Edit</button></a>&nbsp;
                        <a href="index.php?controller=products&action=delete&id=<?php echo $rows->id; ?>" onclick="return window.confirm('Are you sure?');"><button>Delete</button></a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </table>
