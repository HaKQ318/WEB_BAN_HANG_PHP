    ...
    <div class="panel panel-primary">
        ...
        <form method="post" action="<?php echo $action; ?>" enctype="multipart/form-data">
            ...
            <div class="row" style="margin-top:5px;">
                ...
                <div class="col-md-10">
                    <textarea name="description1"><?php echo isset($record->description)?$record->description:''; ?></textarea>
                    <script type="text/javascript">CKEDITOR.replace("description1");</script>
                </div>
            </div>
            <!-- end rows -->
            <!-- rows -->
