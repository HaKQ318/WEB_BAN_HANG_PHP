...
<head>
   ...
   <body>
    ...
    s1.async=true;
    s1.src='https://embed.tawk.to/62b310977b967b117995f29d/1g65nhlqq';
    s1.charset='UTF-8';
    ...
    <!-- facebook comment -->
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v14.0" nonce="Pljp6OrQ"></script>
    <!-- /facebook comment -->
    <!-- /plugin chat -->
      ...
      <footer>
                            ...
                            <ul class="icon_list">
                                <li>
                                    <a href=".">
                                        ...
                                        <p class="text_li">
                                            <span class="phone_footer">Hotline: 0965-724-657</span>
                                            <span class="text_small">(Từ 8h đến 20h tất cả các ngày)</span>
                                        </p>
                                    </a>
                                </li>
                                <div class="clear"></div>
                                <li><a><i class="fa fa-envelope" aria-hidden="true"></i>  khongquanghano1@gmail.com</a></li>
                                <li><a><i class="fa fa-mouse-pointer" aria-hidden="true"></i>  https://hano1.com</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg_in">
                <div class="footer">
                    <div class="infor_company">
                        <h3>CÔNG TY THIẾT KẾ WEBSITE </h3>
                        ...
                        <p class="note_mst">GPĐKKD số: 888888. Cấp lần 1: 01/01/2022. Thay đổi: 01/06/2022. Nơi cấp: Phòng đăng ký kinh doanh Sở kế hoạch đầu tư TP Vĩnh Yên</p>
                    </div>
                    <div class="footer-col">
                        <h4>TRỤ SỞ CHÍNH</h4>
                        <div class="infor_footer">
                            <address>
                        <address>Địa Chỉ : Liên Bảo, Vĩnh Yên, Vĩnh Phúc<br />
                           Điện thoại: 0965-724-657<br />
                           Email: khongquanghano1@gmail.com
                        </address>
                            </address>
                        </div>
                    </div>
        ...
        <div class="clear"></div>
        <div class="copyright">
            <h4 class="tkw9999">&copy;  © Bản quyền thuộc về KhongQuangHa. Designed by <a href="http://webextrasite.com/" rel="dofollow" target="_blank">Thiet Ke Web</a> Bởi <a href="http://webextrasite.com/">KhongQuangHa</a></h4>
        </div>
    </footer>
    ...
    <script defer type="assets/frontend/text/javascript" src="js/script_ex.js"></script>
